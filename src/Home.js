...
const Products = () => {
  ...
  return (
    <Container className="mt-3">
      <strong style={{fontWeight:'800', fontSize:'80px',alignItems:'cemter', textAlign:"center"}}>Featured products</strong>
      <Row className="mb-3">
        <Col>
            ...
            <Col key={product.id} className='mb-5'>
              <Card className="mb-3 h-100">
                ...
                <Link to={`/products/${product.id}`}>
                  ...
                  <Button variant="primary" className="position-absolute bottom-0 start-0"
